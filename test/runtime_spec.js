...
describe("Runtime library tests", function () {
  ...
  xit("ascii()", function () {
    ...
    ";
    expect(util.run(code)).to.equal("'TEST\\xd4\\u1234\\U00028b4e'");
  });
  ...
  it("chr(97)", function () {
    ...
    return chr(97)\
    ";
    expect(util.run(code)).to.equal('a');
  });

  it("divmod(17, 6)", function () {
    var code = "\
    return str(divmod(17, 6))";
    expect(util.run(code)).to.equal('(2, 5)');
  });
  ...
  it("enumerate(seq, 7)", function () {
    ...
    return e[1][0]\
    ";
    expect(util.run(code)).to.equal(8);
  });
  ...
  it("filter(fn, seq)", function () {
    ...
    return filter(f, ['a', 'b'])\
    ";
    expect(util.run(code)).to.deep.equal(['b']);
  });
  ...
  it("filter(None, seq)", function () {
    ...
    ";
    expect(util.run(code)).to.deep.equal(['a', 'b']);
  });
  ...
  it("float('+1E6')", function () {
    ...
    return float('+1E6')\
    ";
    expect(util.run(code)).to.equal(1000000);
  });
  ...
  it("hex(15)", function () {
    ...
    return hex(15)\
    ";
    expect(util.run(code)).to.equal('f');
  });
  ...
  it("int('5')", function () {
    ...
    return int('5')\n\
    ";
    expect(util.run(code)).to.equal(5);
  });
  it("int('0')", function () {
    var code = "\
    return int('0')\n\
    ";
    expect(util.run(code)).to.equal(0);
  });
  it("int('-5')", function () {
    var code = "\
    return int('-5')\n\
  ...
  it("list([5, 3, -24])", function () {
    ...
    return d[2]\n\
    ";
    expect(util.run(code)).to.equal(-24);
  });
  ...
  it("list({'one':1, 'two':2})", function () {
    ...
    return d[1]\n\
    ";
    expect(util.run(code)).to.equal('two');
  });
  ...
  it("max([1, 2, -34, 23423])", function () {
    ...
    ";
    expect(util.run(code)).to.equal(23423);
  });
  ...
  it("min(-1, -234)", function () {
    ...
    return min(-1, -234)\n\
    ";
    expect(util.run(code)).to.equal(-234);
  });
  ...
  it("min([1, 2, -34, 23423])", function () {
    ...
    ";
    expect(util.run(code)).to.equal(-34);
  });
  ...
  it("ord(\u2020)", function () {
    ...
    return ord('\u2020')\n\
    ";
    expect(util.run(code)).to.equal(8224);
  });
  ...
  it("range(3)", function () {
    ...
    return range(3)\n\
    ";
    expect(util.run(code)).to.deep.equal([0, 1, 2]);
  });
  ...
  it("range(2, 5)", function () {
    ...
    return range(2, 5)\n\
    ";
    expect(util.run(code)).to.deep.equal([2, 3, 4]);
  });
  ...
  it("range(0, 30, 10)", function () {
    ...
    ";
    expect(util.run(code)).to.deep.equal([0, 10, 20]);
  });
  ...
  it("range(0, -5, -1)", function () {
    ...
    return range(0, -5, -1)\n\
    ";
    expect(util.run(code)).to.deep.equal([0, -1, -2, -3, -4]);
  });
  ...
  it("range(1, 0)", function () {
    ...
    return range(1, 0)\n\
    ";
    expect(util.run(code)).to.deep.equal([]);
  });
  ...
  it("range(0, 10, 4)", function () {
    ...
    return range(0, 10, 4)\n\
    ";
    expect(util.run(code)).to.deep.equal([0, 4, 8]);
  });
  ...
  it("range(9, -2, -4)", function () {
    ...
    return range(9, -2, -4)\n\
    ";
    expect(util.run(code)).to.deep.equal([9, 5, 1]);
  });
  ...
  it("repr()", function () {
    ...
    return repr(88)\n\
    ";
    expect(util.run(code)).to.equal('88');
  });
  ...
  it("reversed()", function () {
    ...
    return reversed(['a', 'b'])\n\
    ";
    expect(util.run(code)).to.deep.equal(['b', 'a']);
  });
  ...
  it("round(10.4)", function () {
    ...
    return round(10.4)\n\
    ";
    expect(util.run(code)).to.equal(10);
  });
  ...
  it("round(2.675, 2)", function () {
    ...
    ";
    expect(util.run(code)).to.equal(2.68);
  });
  ...
  it("sorted([2, 1], cmp)", function () {
    ...
    return sorted(a, cmp)\n\
    ";
    expect(util.run(code)).to.deep.equal([2, 1]);
  });
  ...
  it("str()", function () {
    ...
    return str(4)\n\
    ";
    expect(util.run(code)).to.equal('4');
  });
  ...
  it("createList(4, 3, 'mahalo', 8998)", function () {
    ...
    expect(list._isPython).to.equal(true);
    expect(list).to.deep.equal([4, 3, 'mahalo', 8998]);
  });
  ...
  it("convertToList(['a', 'zoo', True, 45])", function () {
    ...
    var list = util.run(code);
    expect(list._isPython).to.equal(true);
    expect(list).to.deep.equal(['a', 'zoo', true, 45]);
  });
  ...
  it("convertToDict({'p1': 45, 'p2': False, 'p3': 'Bob'})", function () {
    ...
    expect(dict._isPython).to.equal(true);
    expect(dict).to.deep.equal({'p1': 45, 'p2': false, 'p3': 'Bob', 'randoProp': 'hi'});
  });
  ...
  it("createDict({'p1': 45, 'p2': False, 'p3': 'Bob'})", function () {
    ...
    var dict = util.run(code);
    expect(dict._isPython).to.equal(true);
    expect(dict).to.deep.equal({'p1': 45, 'p2': false, 'p3': 'Bob'});
  });
  ...
  it("createDict({'type': 'merino wool'})", function () {
    ...
    var dict = util.run(code);
    expect(dict._type).to.equal('dict');
    expect(dict.type).to.equal('merino wool');
    expect(dict).to.deep.equal({'type': 'merino wool'});
  });
