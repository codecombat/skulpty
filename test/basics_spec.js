...
describe("Basics", function () {
  it("return 1000", function () {
    ...
    expect(util.run(code)).to.equal(1000);
  });
  ...
  it("no indent, if elif else, else", function () {
    ...
    ";
    expect(util.run(code)).to.equal('else');
  });
...
if x == 2:\n\
  ...
  it("while loop", function () {
    ...
    return total\n\
    ";
    expect(util.run(code)).to.equal(71);
  });
  ...
  it("for loop", function () {
    ...
    return total\n\
    ";
    expect(util.run(code)).to.equal(78);
  });
  ...
  it("default arguments", function () {
    ...
    def f(x, y=5, z=7):\n\
      return x + y + z\n\
    return f(1)";
    expect(util.run(code)).to.equal(13);
  });
  ...
  it("keyword arguments", function () {
    ...
    def f(x, y=5, z=7):\n\
      return x + y + z\n\
    return f(1, z=2, y=50)";
    expect(util.run(code)).to.equal(53);
  });
  ...
  it("*args", function () {
    ...
    def f(x, y=5, z=7, *a):\n\
      return x + y + z + sum(a)\n\
    return f(1, 2, 50, 5, 6)";
    expect(util.run(code)).to.equal(64);
  });
  ...
  it("**kwargs", function () {
    ...
    expect(util.run(code)).to.equal(74);
  });
