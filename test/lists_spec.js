...
describe("Lists", function () {
  ...
  it("[x for x in range(4)]", function () {
    ...
    return L";
    expect(util.run(code)).to.deep.equal([0, 1, 2, 3]);
  });
  ...
  it("[x*2 for x in range(4) if x > 1]", function () {
    ...
    return L";
    expect(util.run(code)).to.deep.equal([4, 6]);
  });
  ...
  it("[(x*2, y) for x in range(4) if x > 1 for y in range(2)]", function () {
    ...
    return L[1]";
    expect(util.run(code)).to.deep.equal([4, 1]);
  });
  ...
  it("[x**2 for x in range(10)]", function () {
    ...
    return L";
    expect(util.run(code)).to.deep.equal([0, 1, 4, 9, 16, 25, 36, 49, 64, 81]);
  });
  ...
  it("[(x, y) for x in [1,2,3] for y in [3,1,4] if x != y]", function () {
    ...
    return L";
    expect(util.run(code)).to.deep.equal([[1, 3], [1, 4], [2, 3], [2, 1], [2, 4], [3, 1], [3, 4]]);
  });
  ...
  it("[x*2 for x in vec]", function () {
    ...
    L = [x*2 for x in vec]\n\
    return L";
    expect(util.run(code)).to.deep.equal([-8, -4, 0, 4, 8]);
  });
  ...
  it("[abs(x) for x in vec]", function () {
    ...
    return L";
    expect(util.run(code)).to.deep.equal([4, 2, 0 , 2, 4]);
  });
  ...
  it("[str(round(pi, i)) for i in range(1, 6)]", function () {
    ...
    return L";
    expect(util.run(code)).to.deep.equal(['3.1', '3.14', '3.142', '3.1416', '3.14159']);
  });
  ...
  it("[[row[i] for row in matrix] for i in range(4)]", function () {
    ...
    return transpose";
    expect(util.run(code)).to.deep.equal([[1, 5, 9], [2, 6, 10], [3, 7, 11], [4, 8, 12]]);
  });
  ...
  it("[1, 2] + [3]", function () {
    var code = "\n\
    return [1, 2] + [3]";
    expect(util.run(code)).to.deep.equal([1, 2, 3]);
  });
  ...
  it("a = a + [True, 0]", function () {
    ...
    a = a + [True, 0]\n\
    return a";
    expect(util.run(code)).to.deep.equal([45, 23, -4, 'hi', true, 0]);
  });
  ...
  it("[0] * 2", function () {
    var code = "\n\
    return [0] * 2";
    expect(util.run(code)).to.deep.equal([0, 0]);
  });
  ...
  it("[8] *= 4", function () {
    ...
    a *= 4\n\
    return a";
    expect(util.run(code)).to.deep.equal([8, 8, 8, 8]);
  });
  ...
  it("['hi'] *= 2", function () {
    ...
    a *= 2\n\
    return a";
    expect(util.run(code)).to.deep.equal(['hi', 'hi']);
  });
  ...
  it("[100, 1, 0, 22, 33, 5, 55].sort()", function () {
    ...
    a.sort()\n\
    return a";
    expect(util.run(code)).to.deep.equal([0, 1, 5, 22, 33, 55, 100]);
  });
  ...
  it("[100, 1, 0, 22, 33, 5, 55].sort(mykey)", function () {
    ...
    a.sort(mykey)\n\
    return a";
    expect(util.run(code)).to.deep.equal([100, 55, 33, 22, 5, 1, 0]);
  });
