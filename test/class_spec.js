...
describe("Class", function () {
  it("data attribute", function () {
    ...
    return x.i\n\
    ";
    expect(util.run(code)).to.equal(12345);
  });
  ...
  it("method attribute", function () {
    ...
    return x.f()\n\
    ";
    expect(util.run(code)).to.equal('hello world');
  });
  ...
  it("global scope", function () {
    ...
    return s\n\
    ";
    expect(util.run(code)).to.equal('global scope');
  });
  ...
  it("class scope, class var", function () {
    ...
    return x.s\n\
    ";
    expect(util.run(code)).to.equal('class scope');
  });
  ...
  it("class scope, method var", function () {
    ...
    return x.f()\n\
    ";
    expect(util.run(code)).to.equal('method scope');
  });
  ...
  it("__init__", function () {
    ...
    return x.f()\n\
    ";
    expect(util.run(code)).to.equal(7);
  });
  ...
  it("__init__ with args", function () {
    ...
    return x.f()\n\
    ";
    expect(util.run(code)).to.equal(9);
  });
  ...
  //  return xf()\n\
  //  ";
  //  expect(util.run(code)).to.equal('hello word');
  //});
  ...
  it("single inheritance, method override", function () {
    ...
    return x.f()\n\
    ";
    expect(util.run(code)).to.equal('child');
  });
  ...
  xit("class/function name conflict", function () {
    ...
    return x\n\
    ";
    expect(util.run(code)).to.equal(123);
  });
  ...
  //  return x.f(1)\n\
  //  ";
  //  expect(util.run(code)).to.equal(14);
  //});
  ...
  //  ";
  //  expect(util.run(code)).to.equal(12);
  //});
  ...
  //  ";
  //  expect(util.run(code)).to.equal(125);
  //});
